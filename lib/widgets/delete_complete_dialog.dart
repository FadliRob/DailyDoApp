...
class DeleteCompleteDialog extends StatefulWidget {
  ...
  @override
  State<DeleteCompleteDialog> createState() => _DeleteCompleteDialogState();
}

class _DeleteCompleteDialogState extends State<DeleteCompleteDialog> {
  @override
  ...
  void _deleteCompletes() async {
    var collection = FirebaseFirestore.instance.collection('completes');
    try {
